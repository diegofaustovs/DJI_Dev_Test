...
public class TrackingTestActivity extends DemoBaseActivity implements TextureView.SurfaceTextureListener, View.OnClickListener, View.OnTouchListener, ActiveTrackMissionOperatorListener {
